                ...
                { clients.map((client) => (
                  <NavLink
                    ...
                    className={({ isActive, isPending }) => 
                        isActive
                          ? 'w-full my-2 justify-start flex items-center gap-2 bg-black rounded-lg transition-colors duration-200'
                          : isPending
                          ? 'w-full my-2 justify-start flex items-center gap-2 bg-primary/10  rounded-lg transition-colors duration-200'
                          : 'w-full my-2 justify-start flex items-center gap-2 text-muted-foreground  rounded-lg transition-colors duration-200'
                    }
                >
                  <div className={
                    id === client.id
